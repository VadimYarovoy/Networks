...
#align(center)[
    ...
    [*WiFi*], [$-53$], [dBm], [$-53$], [dBm], [$-85$], [dBm], [$-75$], [dBm], [$-61$], [dBm], [$-66$], [dBm],
    )
]

Сравним результаты расчета мощности сигнала на входе приемника с измерениями.

- *2G* - формула была использована неправильно, но расхождения оказались приемлемыми
- *3G* - расхождения допустимы
- *4G* - расхождение оказалось верным для 1 из 3 мест, для двух оставшихся формула оказалась неверной
