...
#math.equation(
  block: true,
  [$
    P L_("3D-UMa-NLOS") &= 161.04 - 7.1 lg(W) + 7.5 lg(h) - (24.37 - 3.7(h / h_("BS"))^2) \
    & dot.op lg(h_("BS")) + (43.42 - 3.1 lg(h_("BS"))) (lg(d_("3D")) - 3) + 20 lg(f_c) - \
    & - (3.2 (lg(17.625))^2 - 4.97) - 0.6 (h_("UT") - 1.5) ", dB"
  $]
)
  
  где расстояние $d_("3D")$ измеряется в метрах, частота сигнала $f_c$ – в ГГц,
  $h$ – средняя высота зданий в диапазоне $5 м < h < 50 м$, типовое
  значение $h = 20 м$,
  $W$ – ширина улицы в диапазоне $5 м < W < 50 м$, типовое значение W 20 м,
  типовое значение $h_("BS") = 25 м$ и $10 м < h_("BS") < 150 м$,
  $1.5 м ≤ h_("UT") ≤ 22.5 м$,
